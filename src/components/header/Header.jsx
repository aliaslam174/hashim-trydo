...
function Header() {
  return (
   ...
   <div className='text-white min-h-[575px] flex  justify-center items-center'>
    <div>
    <h1 className='font-black mb-4  bg-gradient-to-r from-[#f81f01] to-[#ee076e] text-transparent bg-clip-text text-center lg:text-8xl sm:text-4xl text-2xl font-bold'>MUHAMMAD HASHIM</h1>
